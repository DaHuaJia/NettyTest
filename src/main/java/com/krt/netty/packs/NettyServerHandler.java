...
public class NettyServerHandler extends SimpleChannelInboundHandler<ByteBuf> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, ByteBuf msg) {
        ...
        System.out.println("服务端接收消息的次数 = "+(++this.count));
        ...
        ByteBuf receive = Unpooled.copiedBuffer(temp, CharsetUtil.UTF_8);
        // 回送随机数据给客户端
    ...
    /**
     * 通过观察，我们可以得知，当连续接收多个较小的数据包时，通道会将数据打包一起发送，导致接收方收到的数据失真。
     */
